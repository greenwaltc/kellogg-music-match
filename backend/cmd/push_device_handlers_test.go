...
type fakeTokenRepo struct {
	store map[string][]business.DeviceToken
}

// Device tokens
func (f *fakeTokenRepo) UpsertDeviceToken(_ context.Context, _ uuid.UUID, _, _, _, _, _, _, _ string) error {
	return nil
}
func (f *fakeTokenRepo) ListDeviceTokensByUser(_ context.Context, _ uuid.UUID) ([]business.DeviceToken, error) {
	return []business.DeviceToken{}, nil
}
func (f *fakeTokenRepo) DeleteDeviceToken(_ context.Context, _ uuid.UUID, _, _ string) error {
	return nil
}

// Unused PushRepo methods (stubs)
func (f *fakeTokenRepo) UpsertPushSubscription(ctx context.Context, userID *uuid.UUID, endpoint, p256dh, auth, userAgent string) error {
	return nil
}
func (f *fakeTokenRepo) GetPushSubscriptionsByUser(ctx context.Context, userID uuid.UUID) ([]sqlc.PushSubscription, error) {
	return nil, nil
}
func (f *fakeTokenRepo) GetAnyPushSubscriptions(ctx context.Context, lim int32) ([]sqlc.PushSubscription, error) {
	return nil, nil
}
func (f *fakeTokenRepo) DeletePushSubscriptionByEndpoint(ctx context.Context, endpoint string) error {
	return nil
}
