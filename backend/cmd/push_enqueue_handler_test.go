...
func (f *fakePushRepo) UpsertPushSubscription(ctx context.Context, userID *uuid.UUID, endpoint, p256dh, auth, userAgent string) error { return nil }
func (f *fakePushRepo) GetPushSubscriptionsByUser(ctx context.Context, userID uuid.UUID) ([]sqlc.PushSubscription, error) { return nil, nil }
func (f *fakePushRepo) GetAnyPushSubscriptions(ctx context.Context, lim int32) ([]sqlc.PushSubscription, error) { return nil, nil }
func (f *fakePushRepo) DeletePushSubscriptionByEndpoint(ctx context.Context, endpoint string) error { return nil }
func (f *fakePushRepo) GetDistinctPushUserIDs(ctx context.Context, limit, offset int32) ([]uuid.UUID, error) { return f.ids, nil }
