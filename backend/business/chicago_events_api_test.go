...
func TestConcertAPIService_GetChicagoEvents(t *testing.T) {
	...
	t.Run("GetAllChicagoEvents", func(t *testing.T) {
		response, err := service.GetChicagoEvents(ctx, "", 10, 0, false, false, 0)
	...
	t.Run("SearchByArtistName", func(t *testing.T) {
		response, err := service.GetChicagoEvents(ctx, "Rock", 10, 0, false, false, 0)
		require.NoError(t, err)
	...
	t.Run("PaginationWithLimit", func(t *testing.T) {
		response, err := service.GetChicagoEvents(ctx, "", 1, 0, false, false, 0)
		require.NoError(t, err)
	...
	t.Run("PaginationWithOffset", func(t *testing.T) {
		response, err := service.GetChicagoEvents(ctx, "", 1, 1, false, false, 0)
		require.NoError(t, err)
	...
	t.Run("NoResults", func(t *testing.T) {
		response, err := service.GetChicagoEvents(ctx, "NonexistentArtist", 10, 0, false, false, 0)
		require.NoError(t, err)
